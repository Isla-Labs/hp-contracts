...
import { BaseDopplerHookInitializer } from "@doppler/src/base/BaseDopplerHookInitializer.sol";
...
contract RehypeDopplerHookInitializer is BaseDopplerHookInitializer, ReentrancyGuard {
    ...
    function _collectSwapFees(
        ...
        uint24 currentFee = _applyFeeMode(_getCurrentFee(poolId), sender, hookData);
