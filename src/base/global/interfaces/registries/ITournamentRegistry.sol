...
interface ITournamentRegistry {
    // --------------------------------------------
    //  Domestic hubs — TournamentInitializer
    // --------------------------------------------
    ...
    // --------------------------------------------
    //  Hub linking — TournamentInitializer
    // --------------------------------------------

    /// @dev When a new `DOMESTIC_LEAGUE` is created, link its hub into each CONTINENTAL / INTERNATIONAL.
