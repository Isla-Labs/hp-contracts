...
/// @dev Vendored from https://github.com/z-fi/zRouter (MIT) `src/zQuoterBase.sol`.
///      Retargeted Uniswap helpers for **Base Sepolia (84532)**.
///      Sushi / zAMM constants remain upstream stubs (no pools on Sepolia → quotes empty).
///      `ZROUTER` is an immutable set in the constructor.
...
contract ZQuoterBase {
    ...
    /// @dev Target zRouter for calldata builders (set at deploy after ZRouter).
    address public immutable ZROUTER;

    constructor(address zRouter_) payable {
        require(zRouter_ != address(0), "ZROUTER");
        ZROUTER = zRouter_;
    }
...
address constant V3_QUOTER = 0xC5290058841028F1614F3A6F0F5816cAd0df5E27;
...
// --- Uniswap v4 (Ethereum) ---
address constant V4_STATE_VIEW = 0x571291b572ed32ce6751a2Cb2486EbEe8DEfB9B4;
