...
contract PbrTreasuryFactoryTest is VaultsTestBase {
    ...
    function test_create_revertsUnauthorized() public {
        ...
        treasuryFactory.create(TOURNAMENT, SEASON, salt);
    }
    ...
    function test_create_revertsZeroId() public {
        ...
        treasuryFactory.create(bytes32(0), SEASON, salt);
    }
    ...
    function test_create_revertsZeroSalt() public {
        ...
        treasuryFactory.create(TOURNAMENT, SEASON, bytes32(0));
    }
    ...
    function test_create_wiresTreasury() public {
        ...
        vm.prank(orchestrator);
        address treasuryAddr = treasuryFactory.create(TOURNAMENT, SEASON, salt);
        ...
        assertEq(treasury.seasonId(), SEASON);
